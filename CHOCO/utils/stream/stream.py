...
## powered by CHOCO Halder & Aditya Halder
...
from CHOCO import Carbon, YouTube, app
from CHOCO.core.call import CHOCOh
from CHOCO.misc import db
from CHOCO.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from CHOCO.utils.exceptions import AssistantErr
from CHOCO.utils.inline.play import (stream_markup, queue_markup,
                                          telegram_markup)
from CHOCO.utils.inline.playlist import close_markup
from CHOCO.utils.pastebin import CHOCOhbin
from CHOCO.utils.stream.queue import put_queue, put_queue_index
from CHOCO.utils.thumbnails import gen_thumb, gen_qthumb
...
async def stream(
    ...
    if forceplay:
        await CHOCOh.force_stop_stream(chat_id)

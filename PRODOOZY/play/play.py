...
from CHOCO.config import BANNED_USERS, lyrical
from CHOCO.DLK import get_command
from CHOCO import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
from CHOCO.core.call import CHOCOh
from CHOCO.utils import seconds_to_min, time_to_seconds
from CHOCO.utils.channelplay import get_channeplayCB
from CHOCO.utils.database import is_video_allowed
from CHOCO.utils.decorators.language import languageCB
from CHOCO.utils.decorators.play import PlayWrapper
from CHOCO.utils.teamdlkmusic.proX import command
from CHOCO.utils.formatters import formats
from CHOCO.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from CHOCO.utils.database import is_served_user
from CHOCO.utils.inline.playlist import botplaylist_markup
from CHOCO.utils.logger import play_logs
from CHOCO.utils.stream.stream import stream
    ...
    if audio_telegram:
        ...
        if await YouTube.exists(url):
            ...
            if (
                ...
                return await mystic.edit_text(
                    "𝐓𝐡𝐢𝐬 𝐁𝐨𝐭 𝐂𝐚𝐧'𝐭 𝐏𝐥𝐚𝐲 𝐒𝐩𝐨𝐭𝐢𝐟𝐲 𝐓𝐫𝐜𝐤𝐬 𝐨𝐫 𝐏𝐥𝐚𝐲𝐥𝐢𝐬𝐭𝐬 𝐑𝐞𝐩𝐨𝐫𝐭 [DOOZY sᴜᴘᴘᴏʀᴛ](https://t.me/DOOZY_OFF_TOPIC)."
                )
            if "track" in url:
                try:
            ...
            try:
                await CHOCOh.stream_call(url)
            except NoActiveGroupCall:
                await mystic.edit_text(
                    "There's An Error In The Bot Then Report [DOOZY sᴜᴘᴘᴏʀᴛ](https://t.me/DOOZY_OFF_TOPIC  ) AN Error"
                )
...
@app.on_callback_query(
    filters.regex("CHOCOhPlaylists") & ~BANNED_USERS
)
@languageCB

...
from CHOCO.config import BANNED_USERS, SERVER_PLAYLIST_LIMIT
from CHOCO.DLK import get_command
from CHOCO import Carbon, YouTube, app
from CHOCO.utils.database import (delete_playlist, get_playlist,
                                       get_playlist_names,
                                       save_playlist)
from CHOCO.utils.decorators.language import language, languageCB
...
async def add_playlist(client, CallbackQuery, _):
    ...
    try:
        ...
        return await CallbackQuery.message.reply_text(
            text="☘ 𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 𝐏𝐥𝐚𝐲𝐥𝐢𝐬𝐭 𝐀𝐝𝐝𝐞𝐝.\n │\n └𝐑𝐞𝐪𝐮𝐞𝐬𝐭𝐞𝐝 𝐁𝐲 : {0} \n\n 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 [ＰＲＯ➝ＤＯＯＺＹ](https://t.me/DOOZY_OFF)".format(CallbackQuery.from_user.mention),

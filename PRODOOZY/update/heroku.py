...
from CHOCO.misc import HAPP, SUDOERS, XCB
from CHOCO.utils.database import (get_active_chats,
                                       remove_active_chat,
...
async def vardel_(client, message, _):
    ...
    if await is_heroku():
        ...
        if not output[0]:
            ...
            await message.reply_text(_["heroku_7"].format(check_var))
            os.system(f"kill -9 {os.getpid()} && python3 -m CHOCO")
...
async def usage_dynos(client, message, _):
    ...
    useragent = (
        ...
        "AppleWeproXit/537.36 (KHTML, like Gecko) "
...
async def restart_(_, message):
    ...
    try:
        ...
        pass
    await response.edit(
        "𝐌𝐮𝐬𝐢𝐜 𝐁𝐨𝐭 𝐑𝐞𝐛𝐨𝐨𝐭 𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 ! 𝐖𝐚𝐢𝐭 𝐅𝐞𝐰 𝐌𝐢𝐧𝐮𝐭𝐞𝐬.."
    )
    os.system(f"kill -9 {os.getpid()} && python3 -m CHOCO")

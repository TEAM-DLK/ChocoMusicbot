...
from CHOCO.config import BANNED_USERS, MUSIC_BOT_NAME
from CHOCO.DLK import get_command
from CHOCO import YouTube, app
from CHOCO.core.userbot import assistants
from CHOCO.misc import SUDOERS, mongodb
from PRODOOZY import ALL_MODULES
from CHOCO.utils.database import (get_global_tops,
                                       get_particulars, get_queries,
                                       get_served_chats,
                                       get_served_users, get_sudoers,
                                       get_top_chats, get_topp_users)
from CHOCO.utils.decorators.language import language, languageCB
from CHOCO.utils.inline.stats import (back_stats_buttons,
                                           back_stats_markup,
                                           get_stats_markup,

...
from CHOCO.utils import (CHOCOhbin, get_channeplayCB,
                              seconds_to_min)
from CHOCO.utils.database import (get_cmode, is_active_chat,
                                       is_music_playing)
from CHOCO.utils.decorators.language import language, languageCB
from CHOCO.utils.inline import queue_back_markup, queue_markup

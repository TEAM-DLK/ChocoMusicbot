...
from CHOCO.config import BANNED_USERS, MUSIC_BOT_NAME, adminlist, lyrical
from CHOCO.DLK import get_command
from CHOCO import app
from CHOCO.core.call import CHOCOh
from CHOCO.misc import db
from CHOCO.utils.database import get_authuser_names, get_cmode
from CHOCO.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from CHOCO.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await CHOCOh.stop_stream(message.chat.id)
    except:
        pass
